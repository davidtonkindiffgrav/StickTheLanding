...
STATIC_PAGES = [
    ...
    (f"{BASE}/code-of-points/wag/",       "monthly", "0.6"),
    (f"{BASE}/code-of-points/wag/vault/", "monthly", "0.6"),
    (f"{BASE}/code-of-points/wag/bars/",  "monthly", "0.6"),
    (f"{BASE}/code-of-points/wag/beam/",  "monthly", "0.6"),
    (f"{BASE}/code-of-points/wag/floor/", "monthly", "0.6"),
